...
void libcli_register_display_callback(param_t *param,
...
void set_device_name(const char *cons_name)
{
 ...
 *-----------------------------------------------------------------------------*/
void goto_top_of_cmd_tree(param_t *curr_cmd_tree_cursor)
{
...
void go_one_level_up_cmd_tree(param_t *curr_cmd_tree_cursor)
{
 ...
 *-----------------------------------------------------------------------------*/
void build_mode_console_name(param_t *dst_param)
{
...
void build_cmd_tree_leaves_data(ser_buff_t *tlv_buff, /*Output serialize buffer*/
